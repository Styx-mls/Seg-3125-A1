...
export default function Portfolio() {
  return (
    ...
    <div>
      <div className="h-box p-4 border-bottom shadow-sm"
      ...
      style = {{width: "fit-content", margin: "0 auto", gap: "100px", maxWidth: "900px", marginBottom : "100px"}}
      >
      ...
      <div className = "p-box p-4 border rounded shadow-sm mt-5"
      ...
      style = {{marginTop: "20px"}}>
        ...
        <div className="card" style={{ width: "11rem" }}>
          <img
            src="https://plus.unsplash.com/premium_photo-1683141410787-c4dbd2220487?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8cGx1bWJpbmd8ZW58MHx8MHx8fDA%3D"
